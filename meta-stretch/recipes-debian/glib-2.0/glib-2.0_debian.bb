...
DEPENDS_append_class-target = "${@bb.utils.contains('DISTRO_FEATURES', 'ptest', ' dbus', '', d)} libpcre libmount1"
DEPENDS_class-native = "libtool-native pkgconfig-native gettext-native libffi-native zlib-native"
